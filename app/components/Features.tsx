...
import { Phone, Calendar, MessageSquare, BarChart3, Clock, Users, Sparkles, ArrowRight, Zap } from "lucide-react";
...
const features = [
  {
    icon: Phone,
    title: "Answer Every\nDental Inquiry",
    description: "Sonva handles new patient calls, emergency requests, and routine questions while you're with patients.",
  ...
  },
  {
    icon: MessageSquare,
    title: "Insurance &\nTreatment Info",
    description: "Answers questions about insurance coverage, treatment costs, and available dental procedures.",
  ...
  },
  {
    icon: Clock,
    title: "After-Hours\nEmergency Line",
    description: "Handles evening and weekend calls when your dental office is closed - never lose an emergency patient.",
  ...
  return (
    <section className="relative py-32 overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-accent/20 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: "2s" }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/10 rounded-full blur-[150px] animate-pulse" style={{ animationDelay: "4s" }} />
      </div>

      <div className="container px-4 mx-auto relative z-10">
        {/* Header */}
        <div className="text-center max-w-5xl mx-auto mb-32">
          <div className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border border-primary/20 backdrop-blur-sm mb-10 animate-fade-in">
            ...
            >
              ...
              <div className="flex-shrink-0 relative group">
                ...
                <div 
                  ...
                  style={{
                    transform: activeIndex === index ? 'scale(1.1) rotate(10deg)' : 'scale(1) rotate(0deg)'
                  }}
                >
              ...
              <div className="flex-1 min-w-0">
                <div className="relative">
                  ...
                  <div 
                    ...
                    } top-1/2 -translate-y-1/2 w-0 h-[2px] bg-gradient-to-r ${feature.gradient} transition-all duration-700`}
                    style={{
                  ...
                  <div 
                    ...
                    style={{
                      transform: activeIndex === index ? 'translateX(0)' : feature.position === "right" ? 'translateX(-20px)' : 'translateX(20px)',
                      opacity: activeIndex === index ? 1 : 0.7
                    }}
                  >
                    <h3 
                      className={`text-4xl md:text-6xl lg:text-7xl font-black leading-[0.9] mb-4 whitespace-pre-line transition-all duration-500 ${
                        activeIndex === index 
        ...
        <div className="text-center mt-32">
          <p className="text-muted-foreground text-lg mb-4">Hover over features to learn more</p>
