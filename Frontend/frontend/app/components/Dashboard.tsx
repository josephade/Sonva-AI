...
const Dashboard = () => {
  return (
    <section className="relative py-32 sm:py-40 overflow-hidden px-4">
      ...
      {/* 3D Scene */}
      <div className="absolute inset-0 z-0 pointer-events-none max-h-[60vh] sm:max-h-none">
      ...
      {/* Foreground */}
      <div className="relative container mx-auto px-0 sm:px-4 z-10">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-extrabold mb-4 leading-snug sm:leading-tight break-words">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-12">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="relative group p-6 rounded-2xl border border-border/50 bg-gradient-to-br from-card/50 to-card/30 backdrop-blur-xl"
            >
              <div className="relative flex flex-col items-center justify-center space-y-3 z-10">
                ...
                <div className="text-3xl sm:text-4xl font-bold text-primary drop-shadow-sm">{stat.value}</div>
